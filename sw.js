const CACHE = 'gastocerto-v3.16-itens-projetados';
const SHELL = ['./', './index.html', './offline.html', './style.css?v=3.16', './app.js?v=3.16', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
