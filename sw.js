const CACHE = 'gastocerto-v4.4-visibilidade';
const SHELL = ['./', './index.html', './offline.html', './style.css?v=4.4', './app.js?v=4.4', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
