const CACHE = 'gastocerto-v3.10-installment-current';
const SHELL = ['./', './index.html', './offline.html', './style.css?v=3.10', './app.js?v=3.10', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
