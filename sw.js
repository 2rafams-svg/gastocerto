const CACHE = 'gastocerto-v5.18-orcamento-zero';
const SHELL = ['./', './index.html', './offline.html', './style.css?v=5.18', './app.js?v=5.18', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
